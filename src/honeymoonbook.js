...
export const BOOK_PAGES_AR = [
  ...
  { kind: 'chapter', label: 'الفصل ٢', n: 'الثاني', title: 'صباح المطار', lines: [
    'جا الصباح أسرع مما توقّعنا. وداع أخير، وحضنة أخيرة، ونظرة أخيرة للبيت.',
    'المطار كان مثيرًا بس هادئ. وقفنا على ماتشا، وسلّمنا الشنط، واكتشفنا إن المسموح ٢٣ كيلو — قلق بسيط وإعادة ترتيب سريعة.',
  ...
  { kind: 'chapter', label: 'الفصل ٣', n: 'الثالث', title: 'الرحلة اللي ما بغينا تنتهي', lines: [
    ...
    'فيه رحلات نتذكّرها لأنها كانت طويلة، وفيه رحلات نتذكّرها لأننا تمنّينا تطول أكثر. وهذي وحدة منها.',
  ] },
  { kind: 'chapter', label: 'الفصل ٤', n: 'الرابع', title: 'أهلاً بكم في بالي', lines: [
    'أول شي لفت انتباهنا ما كان المطار — كانوا الناس. الكل يبتسم، والكل يرحّب.',
    'السواق ودّانا تجاه أوبود. الطريق طويل والجو حار، ورويدة تعبت شوي. وقفنا — ماء بارد وهواء — وبعد دقائق صار كل شي تمام.',
    'أحيانًا الحب هو ببساطة إنك تقف جنب أحد وهو تعبان.',
  ] },
  { kind: 'chapter', label: 'الفصل ٥', n: 'الخامس', title: 'بيتنا في الغابة', lines: [
    'ما كان فيه شي يجهّزنا للمنتجع. ما كان فندقًا — كان عالمًا ثانيًا.',
    'مخبّأ وسط الغابة. مسبح خاص. أصوات طيور. أشجار بكل مكان. هدوء. سلام.',
    'وقفنا بدون ما نتكلّم. أحيانًا الجمال ما يخلّي مكانًا للكلام.',
  ] },
  { kind: 'chapter', label: 'الفصل ٦', n: 'السادس', title: 'فطور في السرير', lines: [
    ...
    'بس شخصان يبدآن حياة جديدة سوا.',
  ] },
  { kind: 'chapter', label: 'الفصل ٧', n: 'السابع', title: 'الرافتنق', lines: [
    'من أعظم الأيام. نزلنا مئات الدرجات للوادي. النهر. الغابة.',
    'ضحك، ورشّ ماء، وقابلنا ثنائيًا ثانيًا، وشفنا شلالات، وشربنا جوز هند طازج، وحسّينا كأننا أطفال من جديد.',
    'ما كنّا نحاول نبهر أحدًا. كنّا فقط نستمتع إننا مع بعض.',
  ] },
  { kind: 'chapter', label: 'الفصل ٨', n: 'الثامن', title: 'الرقص', lines: [
    'ولا واحد فينا توقّع إن الرقص يصير من أحلى ذكرياتنا.',
    'موسيقى، وحُفاة، وداخل غرفتنا، وضحك، وأخطاء، ومحاولة من جديد.',
    'ما كان فيه جمهور ولا عرض. كان فيه فرح فقط.',
  ] },
  { kind: 'chapter', label: 'الفصل ٩', n: 'التاسع', title: 'السبا', lines: [
    'حسبنا إننا رايحين مساج. وبدل كذا… نمنا. تمامًا.',
    'السبا يطلّ على الطبيعة. طيور، وماء جارٍ، وهواء نقي، وسلام.',
    'لأول مرة من زمن، صارت عقولنا هادية تمامًا.',
  ] },
  ...
  { kind: 'chapter', label: 'الفصل ١١', n: 'الحادي عشر', title: 'التسوّق سوا', lines: [
    ...
    'مو لأننا محتاجين شي — بس لأننا نستمتع نسوّي الأشياء العادية سوا.',
  ] },
  { kind: 'chapter', label: 'الفصل ١٢', n: 'الثاني عشر', title: 'أحاديثنا', lines: [
    ...
    'تكلّمنا عن مستقبلنا، وأولادنا، والشغل، والأحلام، والمال، والإيمان، والعائلة، والكِبر سوا. كل شي.',
    'فيه أحاديث تغيّر حياتك للأبد.',
  ] },
  { kind: 'chapter', label: 'الفصل ١٣', n: 'الثالث عشر', title: 'حلمنا', lines: [
    'ليلة، بعد ما زرنا سبا خيالي، تخيّلنا إننا نبني واحدًا مثله.',
  ...
  { kind: 'chapter', label: 'الفصل ١٥', n: 'الخامس عشر', title: 'إلى أولادنا في المستقبل', lines: [
    ...
    'تخيّلنا أسماءكم، وطباعكم، وضحكاتكم.',
