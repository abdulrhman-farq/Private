...
export const HM_TIMELINE = [
  { id: 't1', location: 'البيت — الرياض', title: 'قبل السفر في البيت', cat: 'romantic', mood: 'رومانسي', story: 'ليلة قبل الرحلة، تعشّينا مع العائلة (محمد سوّى لنا برغر وستيك خرافي)، ورتّبنا الشنط، وعشنا ليلتنا الأولى الخاصة بعد الزواج.', quote: 'الحمد لله عبدالرحمن ساعدني، خلصنا الشنط.' },
